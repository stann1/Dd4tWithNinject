namespace DD4T.Mvc.Providers
{
    ...
    public class SiteMapProviderMdc : StaticSiteMapProvider
    {
        ...
        public override SiteMapNode BuildSiteMap()
        {
            ...
            lock (lock1)
            {
                ...
                // Idea is to build the path like:  /TopLevelSG/SitemapFilename.sitemap
                //var siteSection = "/" + url.Split('/')[2];
                //var siteMapFile = siteSection + SiteMapPath;
